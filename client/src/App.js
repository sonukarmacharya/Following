  ...
  useEffect(async ()=>{
    ...
    <div>
      ...
      <Switch>
        ...
        <ProtectedRoute exact path="/acustomer/:cid/:siid" component={Acustomer_Detail} />
        <ProtectedRoute exact path="/salesperson" component={SalesPerson} />
        <ProtectedRoute exact path="/asalesperson/:id" component={Asales} />
        <ProtectedRoute exact path="/customersUser" component={CustomersUser} />
        <ProtectedRoute exact path="/dasuser/:cid/:siid" component={DasUser} />
        <ProtectedRoute exact path="/customersUserdetail" component={CustomersUser_detail} />
        <ProtectedRoute exact path="/addproducts/:cid/:siid" component={Addproduct} />
        <ProtectedRoute exact path="/customersUser" component={CustomersUser} />
        <ProtectedRoute exact path="/tender" component={Tender} />
